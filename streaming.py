...
class StdOutListener(StreamListener):
    ...
    def process_data(self, raw_data):
        ...
        if tweet['geo'] is not None:
            ...
            words = list(filter(lambda word: len(word) > 2 and "@" not in word and word[:5] != "https" and word not in stopwords.words('french'), words))
...
if __name__ == '__main__':
    ...
    track = ['France','Polytech','Ocean','Ville','Ecole','Ingenieur','Annecy','Grenoble','Paris','Lyon',"ia","adwords","RGPD","CNIL","Cookie","Instagram"]
    languages = ['fr']
